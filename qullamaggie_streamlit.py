...
def analyze(t):
    try:
        ...
        c=df["Close"].squeeze(); l=df["Low"].squeeze()
        ...
        out=df.copy(); out["MA1"]=m1; out["MA2"]=m2; out["MA3"]=m3
...
if "res" in st.session_state:
    ...
    if res:
        ...
        fig.add_scatter(x=d.index,y=d["MA1"],name="MA1")
        fig.add_scatter(x=d.index,y=d["MA2"],name="MA2")
        fig.add_scatter(x=d.index,y=d["MA3"],name="MA3")
